<script setup>
    ...
    const markers = computed(() => {
        ...
        // Get the resource names from the current subcategories
        const resourceNames = new Set();
        props.subcategories.forEach(subcat => {
            if (subcat.resourceList) {
        ...
        // Filter the geocoded locations that match the resource names
    ...
    onMounted(() => {
        ...
        // Center the map on the first marker if it exists
